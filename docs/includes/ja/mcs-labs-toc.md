<div class="cc-lab-toc mcs-path">
  ...
  <div>
    ...
    <ul>
      ...
      <li><a href="/copilot-camp/pages/make/copilot-studio/07-autonomous/">MCS7 - 自律エージェントの作成</a></li>
      <li><a href="/copilot-camp/pages/make/copilot-studio/08-rag/">MCS8 - RAG 向け Azure AI Search の統合</a></li>
      <li><a href="/copilot-camp/pages/make/copilot-studio/09-connected-agents/">MCS9 - 連携エージェント (プレビュー)</a></li>
      <li><a href="/copilot-camp/pages/make/copilot-studio/10-mcp-oauth/">MCS10 - OAuth 2.0 を使用した MCP の利用</a></li>
    </ul>
  </div>
</div>
